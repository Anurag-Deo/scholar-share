...
async def process_paper(pdf_file, url_input, text_input, progress=None):
    ...
    try:
        ...
        if pdf_file is not None:
            ...
            with open("parsed_pdf_content.txt", "r", encoding="utf-8") as f:
                content = f.read()
            source_type = "pdf"
...
async def generate_blog_content(progress=None):
    ...
    try:
        ...
        **Reading Time:** {current_blog.reading_time} minutes
        ...
        # Consider more specific exception handling
        return f"❌ Error generating blog: {e!s}"
    ...
    with gr.Blocks(
        ...
        with gr.Tab("📝 Blog Generation"):
            ...
            with gr.Row():
                ...
                with gr.Column():
                    blog_output = gr.Markdown(label="Generated Blog Content")
        ...
        generate_blog_btn.click(fn=generate_blog_content, outputs=[blog_output])
